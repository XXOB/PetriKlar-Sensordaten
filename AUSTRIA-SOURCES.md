...
## Ergänzung RiverApp-Abgleich 12.09.2026
Der bisherige Kärnten-JSON-Feed enthielt keine Fluss-Wassertemperaturen. Die ausdrücklich verlinkte öffentliche Fluss-Temperaturtabelle liefert zusätzliche Werte, zugeordnet ausschließlich über die amtliche Stationsnummer. Alle sieben angefragten Drau-Stationen sowie Dellach sind enthalten. Salzburg Hydris ergänzt zusätzliche aktuelle Wasserstände; Luft-/Grundwasser-/Quellmessungen werden nicht als Flusswerte verwendet. Alarmgrenzen sind keine aktuellen Beobachtungen. Beide öffentlichen Tabellen sind mit eigener Herkunft und ohne behauptete CC-Lizenz gekennzeichnet. Der Betreiberhinweis auf eine Profiländerung in Flachau verhindert dort die historische Einfärbung.

RiverApp dient ausschließlich zum Auffinden von Stationen und Betreibern, nicht als kopierter Messdatenfeed. Einträge anderer gleichnamiger Flüsse, außerhalb der gezeichneten Abschnitte, private Anbieter ohne geklärte Nutzung sowie reine Abflussmessungen werden nicht automatisch als Pegel-/Temperaturstationen ergänzt.
